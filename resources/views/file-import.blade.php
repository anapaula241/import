...
<body>
    <div class="container mt-5">
        ...
        <form action="{{ route('file-import') }}" method="POST" enctype="multipart/form-data">
                ...
                <br>
                <button class="btn btn-success mr-2" name="btnEnvia" id="btnEnvia">  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-cloud-arrow-down" viewBox="0 0 16 16">
