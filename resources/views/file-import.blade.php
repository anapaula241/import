            ...
            <div class="card-body">
                <form action="{{ route('file-import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="file" class="mt-3" name="file" id="img" placeholder="Choose file">
                    </div>
                    <br>
                    <button class="btn btn-success mr-2  mb-3" name="btnEnvia" id="btnEnvia" disabled="true"> <svg
                    ...
                    <a class="btn btn-secondary  mb-3" href="{{ route('arquivo') }}"> <svg
