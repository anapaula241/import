...
<body>
    <div class="container mt-5  animeLeft">
        ...
        <form >
             ...
             <h5 class="mt-2">Relação de lotes</h5>
            <table class="table table-striped col-md-10">
                ...
                <tbody>
                  ...
                  <tr >
                    ...
                    <td>
                        <a  class="btn btn-success btn-sm" type="button" id="arquivo" href="{{url('arquivo/'.$dado->lote ) }}" >  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-filetype-txt" viewBox="0 0 16 16">
                    ...
                    <td>
                        ...
                        <a class="btn btn-primary btn-sm" id="download"  href="{{ url('download/'.$dado->lote) }}" >  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18 fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
